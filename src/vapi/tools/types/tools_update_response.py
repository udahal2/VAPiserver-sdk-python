...
class ToolsUpdateResponse_Dtmf(UniversalBaseModel):
...
class ToolsUpdateResponse_EndCall(UniversalBaseModel):
...
class ToolsUpdateResponse_Function(UniversalBaseModel):
...
class ToolsUpdateResponse_Ghl(UniversalBaseModel):
...
class ToolsUpdateResponse_Make(UniversalBaseModel):
...
class ToolsUpdateResponse_TransferCall(UniversalBaseModel):
...
class ToolsUpdateResponse_Output(UniversalBaseModel):
