...
class ToolsGetResponse_Dtmf(UniversalBaseModel):
...
class ToolsGetResponse_EndCall(UniversalBaseModel):
...
class ToolsGetResponse_Function(UniversalBaseModel):
...
class ToolsGetResponse_Ghl(UniversalBaseModel):
...
class ToolsGetResponse_Make(UniversalBaseModel):
...
class ToolsGetResponse_TransferCall(UniversalBaseModel):
...
class ToolsGetResponse_Output(UniversalBaseModel):
