...
class ToolsDeleteResponse_Dtmf(UniversalBaseModel):
...
class ToolsDeleteResponse_EndCall(UniversalBaseModel):
...
class ToolsDeleteResponse_Function(UniversalBaseModel):
...
class ToolsDeleteResponse_Ghl(UniversalBaseModel):
...
class ToolsDeleteResponse_Make(UniversalBaseModel):
...
class ToolsDeleteResponse_TransferCall(UniversalBaseModel):
...
class ToolsDeleteResponse_Output(UniversalBaseModel):
