...
class ToolsListResponseItem_Dtmf(UniversalBaseModel):
...
class ToolsListResponseItem_EndCall(UniversalBaseModel):
...
class ToolsListResponseItem_Function(UniversalBaseModel):
...
class ToolsListResponseItem_Ghl(UniversalBaseModel):
...
class ToolsListResponseItem_Make(UniversalBaseModel):
...
class ToolsListResponseItem_TransferCall(UniversalBaseModel):
...
class ToolsListResponseItem_Output(UniversalBaseModel):
