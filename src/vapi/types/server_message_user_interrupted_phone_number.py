...
class ServerMessageUserInterruptedPhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessageUserInterruptedPhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageUserInterruptedPhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageUserInterruptedPhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
