...
class ToolCallBlockTool_Dtmf(UniversalBaseModel):
    """
...
class ToolCallBlockTool_EndCall(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
class ToolCallBlockTool_Voicemail(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
class ToolCallBlockTool_Function(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
class ToolCallBlockTool_Ghl(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
class ToolCallBlockTool_Make(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
class ToolCallBlockTool_TransferCall(UniversalBaseModel):
    """
    This is the tool that the block will call. To use an existing tool, use `toolId`.
    """
...
ToolCallBlockTool = typing.Union[
