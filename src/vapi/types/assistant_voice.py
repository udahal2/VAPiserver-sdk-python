...
class AssistantVoice_Azure(UniversalBaseModel):
    """
...
class AssistantVoice_Cartesia(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_Deepgram(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_11Labs(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_Lmnt(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_Neets(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_Openai(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_Playht(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantVoice_RimeAi(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
