...
class AssistantOverridesVoice_Cartesia(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_Deepgram(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_11Labs(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_Lmnt(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_Neets(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_Openai(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_Playht(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
...
class AssistantOverridesVoice_RimeAi(UniversalBaseModel):
    """
    These are the options for the assistant's voice.
    """
