...
class CreateToolCallBlockDtoMessagesItem_BlockStart(UniversalBaseModel):
...
class CreateToolCallBlockDtoMessagesItem_BlockComplete(UniversalBaseModel):
...
CreateToolCallBlockDtoMessagesItem = typing.Union[
    CreateToolCallBlockDtoMessagesItem_BlockStart, CreateToolCallBlockDtoMessagesItem_BlockComplete
]
