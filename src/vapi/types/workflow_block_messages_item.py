...
class WorkflowBlockMessagesItem_BlockStart(UniversalBaseModel):
...
class WorkflowBlockMessagesItem_BlockComplete(UniversalBaseModel):
...
WorkflowBlockMessagesItem = typing.Union[WorkflowBlockMessagesItem_BlockStart, WorkflowBlockMessagesItem_BlockComplete]
