...
class UpdateToolTemplateDtoDetails_Dtmf(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_EndCall(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_Voicemail(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_Function(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_Ghl(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_Make(UniversalBaseModel):
...
class UpdateToolTemplateDtoDetails_TransferCall(UniversalBaseModel):
