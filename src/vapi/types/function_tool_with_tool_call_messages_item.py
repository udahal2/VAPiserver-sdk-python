...
class FunctionToolWithToolCallMessagesItem_RequestStart(UniversalBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestComplete(UniversalBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestFailed(UniversalBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestResponseDelayed(UniversalBaseModel):
