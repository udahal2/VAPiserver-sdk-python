...
class CreateWorkflowBlockDtoStepsItem_Handoff(UniversalBaseModel):
...
class CreateWorkflowBlockDtoStepsItem_Callback(UniversalBaseModel):
...
CreateWorkflowBlockDtoStepsItem = typing.Union[
    CreateWorkflowBlockDtoStepsItem_Handoff, CreateWorkflowBlockDtoStepsItem_Callback
]
from .handoff_step_block import HandoffStepBlock  # noqa: E402
from .callback_step_block import CallbackStepBlock  # noqa: E402

update_forward_refs(CallbackStep, CreateWorkflowBlockDtoStepsItem_Handoff=CreateWorkflowBlockDtoStepsItem_Handoff)
update_forward_refs(
    CreateWorkflowBlockDto, CreateWorkflowBlockDtoStepsItem_Handoff=CreateWorkflowBlockDtoStepsItem_Handoff
)
update_forward_refs(HandoffStep, CreateWorkflowBlockDtoStepsItem_Handoff=CreateWorkflowBlockDtoStepsItem_Handoff)
update_forward_refs(CreateWorkflowBlockDtoStepsItem_Handoff)
update_forward_refs(CallbackStep, CreateWorkflowBlockDtoStepsItem_Callback=CreateWorkflowBlockDtoStepsItem_Callback)
update_forward_refs(
    CreateWorkflowBlockDto, CreateWorkflowBlockDtoStepsItem_Callback=CreateWorkflowBlockDtoStepsItem_Callback
)
