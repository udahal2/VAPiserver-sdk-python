...
class OutputToolMessagesItem_RequestStart(UniversalBaseModel):
...
class OutputToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class OutputToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class OutputToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
...
OutputToolMessagesItem = typing.Union[
