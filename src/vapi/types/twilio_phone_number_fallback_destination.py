...
class TwilioPhoneNumberFallbackDestination_Number(UniversalBaseModel):
    """
...
class TwilioPhoneNumberFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
TwilioPhoneNumberFallbackDestination = typing.Union[
    TwilioPhoneNumberFallbackDestination_Number, TwilioPhoneNumberFallbackDestination_Sip
]
