...
class VapiPhoneNumberFallbackDestination_Number(UniversalBaseModel):
    """
...
class VapiPhoneNumberFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
VapiPhoneNumberFallbackDestination = typing.Union[
    VapiPhoneNumberFallbackDestination_Number, VapiPhoneNumberFallbackDestination_Sip
]
