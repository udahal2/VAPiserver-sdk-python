...
class FunctionToolMessagesItem_RequestStart(UniversalBaseModel):
...
class FunctionToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class FunctionToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class FunctionToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
...
FunctionToolMessagesItem = typing.Union[
