...
class TransferCallToolMessagesItem_RequestStart(UniversalBaseModel):
...
class TransferCallToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class TransferCallToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class TransferCallToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
