...
ServerMessageEndOfCallReportEndedReason = typing.Union[
    typing.Literal[
        ...
        "call.in-progress.error-vapifault-vapi-500-server-error",
        ...
        "call.in-progress.error-vapifault-phone-call-worker-setup-socket-error",
        "call.in-progress.error-vapifault-phone-call-worker-worker-setup-socket-timeout",
        ...
        "call.in-progress.error-vapifault-openai-500-server-error",
        ...
        "call.in-progress.error-vapifault-google-500-server-error",
        ...
        "call.in-progress.error-vapifault-xai-500-server-error",
        ...
        "call.in-progress.error-vapifault-mistral-500-server-error",
        ...
        "call.in-progress.error-vapifault-inflection-ai-500-server-error",
        ...
        "call.in-progress.error-vapifault-deep-seek-500-server-error",
        ...
        "call.in-progress.error-vapifault-azure-openai-500-server-error",
        ...
        "call.in-progress.error-vapifault-groq-500-server-error",
        ...
        "call.in-progress.error-vapifault-cerebras-500-server-error",
        ...
        "call.in-progress.error-vapifault-anthropic-500-server-error",
        ...
        "call.in-progress.error-vapifault-together-ai-500-server-error",
        ...
        "call.in-progress.error-vapifault-anyscale-500-server-error",
        ...
        "call.in-progress.error-vapifault-openrouter-500-server-error",
        ...
        "call.in-progress.error-vapifault-perplexity-ai-500-server-error",
        ...
        "call.in-progress.error-vapifault-deepinfra-500-server-error",
        ...
        "call.in-progress.error-vapifault-runpod-500-server-error",
        ...
        "call.in-progress.error-vapifault-custom-llm-500-server-error",
        ...
        "call.in-progress.error-vapifault-cartesia-500-server-error",
        "call.in-progress.error-vapifault-cartesia-503-server-error",
        "call.in-progress.error-vapifault-cartesia-522-server-error",
        ...
        "call.in-progress.error-vapifault-eleven-labs-500-server-error",
        ...
        "call.in-progress.error-vapifault-playht-502-gateway-error",
        "call.in-progress.error-vapifault-playht-504-gateway-error",
        ...
        "call.in-progress.error-vapifault-deepgram-returning-500-invalid-json",
        "call.in-progress.error-vapifault-deepgram-returning-502-network-error",
        "call.in-progress.error-vapifault-deepgram-returning-502-bad-gateway-ehostunreach",
