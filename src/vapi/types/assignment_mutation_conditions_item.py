...
class AssignmentMutationConditionsItem_ModelBased(UniversalBaseModel):
...
class AssignmentMutationConditionsItem_RuleBased(UniversalBaseModel):
...
AssignmentMutationConditionsItem = typing.Union[
    AssignmentMutationConditionsItem_ModelBased, AssignmentMutationConditionsItem_RuleBased
]
