...
class BuyPhoneNumberDto(UniversalBaseModel):
    fallback_destination: typing_extensions.Annotated[
        typing.Optional[BuyPhoneNumberDtoFallbackDestination], FieldMetadata(alias="fallbackDestination")
    ...
    area_code: typing_extensions.Annotated[str, FieldMetadata(alias="areaCode")] = pydantic.Field()
    """
