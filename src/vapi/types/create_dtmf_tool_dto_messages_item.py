...
class CreateDtmfToolDtoMessagesItem_RequestStart(UniversalBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestComplete(UniversalBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestFailed(UniversalBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestResponseDelayed(UniversalBaseModel):
