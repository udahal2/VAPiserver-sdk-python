...
class UpdateConversationBlockDto(UncheckedBaseModel):
    messages: typing.Optional[typing.List[UpdateConversationBlockDtoMessagesItem]] = pydantic.Field(default=None)
    """
