...
class CreateByoPhoneNumberDtoFallbackDestination_Number(UniversalBaseModel):
    """
...
class CreateByoPhoneNumberDtoFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
CreateByoPhoneNumberDtoFallbackDestination = typing.Union[
    CreateByoPhoneNumberDtoFallbackDestination_Number, CreateByoPhoneNumberDtoFallbackDestination_Sip
]
