...
class CreateTransferCallToolDtoDestinationsItem_Assistant(UniversalBaseModel):
...
class CreateTransferCallToolDtoDestinationsItem_Step(UniversalBaseModel):
...
class CreateTransferCallToolDtoDestinationsItem_Number(UniversalBaseModel):
...
class CreateTransferCallToolDtoDestinationsItem_Sip(UniversalBaseModel):
