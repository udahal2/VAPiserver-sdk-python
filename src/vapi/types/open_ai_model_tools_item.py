...
class OpenAiModelToolsItem_EndCall(UniversalBaseModel):
...
class OpenAiModelToolsItem_Voicemail(UniversalBaseModel):
...
class OpenAiModelToolsItem_Function(UniversalBaseModel):
...
class OpenAiModelToolsItem_Ghl(UniversalBaseModel):
...
class OpenAiModelToolsItem_Make(UniversalBaseModel):
...
class OpenAiModelToolsItem_TransferCall(UniversalBaseModel):
