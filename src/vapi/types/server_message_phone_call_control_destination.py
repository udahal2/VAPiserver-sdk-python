...
class ServerMessagePhoneCallControlDestination_Number(UniversalBaseModel):
    """
...
class ServerMessagePhoneCallControlDestination_Sip(UniversalBaseModel):
    """
    This is the destination to forward the call to if the request is "forward".
    """
...
ServerMessagePhoneCallControlDestination = typing.Union[
    ServerMessagePhoneCallControlDestination_Number, ServerMessagePhoneCallControlDestination_Sip
]
