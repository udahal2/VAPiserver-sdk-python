...
import pydantic
from .create_sms_send_tool_dto_messages_item import CreateSmsSendToolDtoMessagesItem
from .open_ai_function import OpenAiFunction
from .server import Server
from ..core.pydantic_utilities import IS_PYDANTIC_V2


class CreateSmsSendToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[CreateSmsSendToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
