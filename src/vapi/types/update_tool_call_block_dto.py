...
class UpdateToolCallBlockDto(UniversalBaseModel):
    messages: typing.Optional[typing.List[UpdateToolCallBlockDtoMessagesItem]] = pydantic.Field(default=None)
    """
    ...
    tool: typing.Optional[UpdateToolCallBlockDtoTool] = pydantic.Field(default=None)
    """
