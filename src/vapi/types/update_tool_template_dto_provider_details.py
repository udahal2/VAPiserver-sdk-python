...
class UpdateToolTemplateDtoProviderDetails_Make(UniversalBaseModel):
...
class UpdateToolTemplateDtoProviderDetails_Ghl(UniversalBaseModel):
...
class UpdateToolTemplateDtoProviderDetails_Function(UniversalBaseModel):
