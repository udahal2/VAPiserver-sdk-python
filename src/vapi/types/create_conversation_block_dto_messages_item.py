...
class CreateConversationBlockDtoMessagesItem_BlockStart(UniversalBaseModel):
...
class CreateConversationBlockDtoMessagesItem_BlockComplete(UniversalBaseModel):
...
CreateConversationBlockDtoMessagesItem = typing.Union[
