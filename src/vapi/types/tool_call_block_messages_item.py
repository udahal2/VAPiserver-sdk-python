...
class ToolCallBlockMessagesItem_BlockStart(UniversalBaseModel):
...
class ToolCallBlockMessagesItem_BlockComplete(UniversalBaseModel):
...
ToolCallBlockMessagesItem = typing.Union[ToolCallBlockMessagesItem_BlockStart, ToolCallBlockMessagesItem_BlockComplete]
