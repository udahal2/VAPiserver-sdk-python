...
class ByoPhoneNumberFallbackDestination_Number(UniversalBaseModel):
    """
...
class ByoPhoneNumberFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
ByoPhoneNumberFallbackDestination = typing.Union[
    ByoPhoneNumberFallbackDestination_Number, ByoPhoneNumberFallbackDestination_Sip
]
