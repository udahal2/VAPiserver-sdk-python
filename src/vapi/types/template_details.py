...
class TemplateDetails_Dtmf(UniversalBaseModel):
...
class TemplateDetails_EndCall(UniversalBaseModel):
...
class TemplateDetails_Voicemail(UniversalBaseModel):
...
class TemplateDetails_Function(UniversalBaseModel):
...
class TemplateDetails_Ghl(UniversalBaseModel):
...
class TemplateDetails_Make(UniversalBaseModel):
...
class TemplateDetails_TransferCall(UniversalBaseModel):
