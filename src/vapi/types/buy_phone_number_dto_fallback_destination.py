...
class BuyPhoneNumberDtoFallbackDestination_Number(UniversalBaseModel):
    """
...
class BuyPhoneNumberDtoFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
BuyPhoneNumberDtoFallbackDestination = typing.Union[
    BuyPhoneNumberDtoFallbackDestination_Number, BuyPhoneNumberDtoFallbackDestination_Sip
]
