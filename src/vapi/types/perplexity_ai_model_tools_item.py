...
class PerplexityAiModelToolsItem_Dtmf(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_EndCall(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_Voicemail(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_Function(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_Ghl(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_Make(UniversalBaseModel):
...
class PerplexityAiModelToolsItem_TransferCall(UniversalBaseModel):
