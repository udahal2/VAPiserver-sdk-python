...
class ServerMessageTransferDestinationRequestPhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageTransferDestinationRequestPhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageTransferDestinationRequestPhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
