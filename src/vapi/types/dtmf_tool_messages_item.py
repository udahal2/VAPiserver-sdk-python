...
class DtmfToolMessagesItem_RequestStart(UniversalBaseModel):
...
class DtmfToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class DtmfToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class DtmfToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
...
DtmfToolMessagesItem = typing.Union[
