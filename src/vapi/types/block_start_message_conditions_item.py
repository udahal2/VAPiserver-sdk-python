...
class BlockStartMessageConditionsItem_ModelBased(UniversalBaseModel):
...
class BlockStartMessageConditionsItem_RuleBased(UniversalBaseModel):
...
BlockStartMessageConditionsItem = typing.Union[
