...
class CreateOutputToolDtoMessagesItem_RequestStart(UniversalBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestComplete(UniversalBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestFailed(UniversalBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestResponseDelayed(UniversalBaseModel):
