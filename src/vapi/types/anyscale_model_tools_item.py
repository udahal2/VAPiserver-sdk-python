...
class AnyscaleModelToolsItem_Dtmf(UniversalBaseModel):
...
class AnyscaleModelToolsItem_EndCall(UniversalBaseModel):
...
class AnyscaleModelToolsItem_Voicemail(UniversalBaseModel):
...
class AnyscaleModelToolsItem_Function(UniversalBaseModel):
...
class AnyscaleModelToolsItem_Ghl(UniversalBaseModel):
...
class AnyscaleModelToolsItem_Make(UniversalBaseModel):
...
class AnyscaleModelToolsItem_TransferCall(UniversalBaseModel):
