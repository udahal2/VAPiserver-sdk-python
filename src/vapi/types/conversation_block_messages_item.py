...
class ConversationBlockMessagesItem_BlockStart(UniversalBaseModel):
...
class ConversationBlockMessagesItem_BlockComplete(UniversalBaseModel):
...
ConversationBlockMessagesItem = typing.Union[
    ConversationBlockMessagesItem_BlockStart, ConversationBlockMessagesItem_BlockComplete
]
