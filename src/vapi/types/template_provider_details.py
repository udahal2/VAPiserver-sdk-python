...
class TemplateProviderDetails_Make(UniversalBaseModel):
...
class TemplateProviderDetails_Ghl(UniversalBaseModel):
...
class TemplateProviderDetails_Function(UniversalBaseModel):
...
TemplateProviderDetails = typing.Union[
    TemplateProviderDetails_Make, TemplateProviderDetails_Ghl, TemplateProviderDetails_Function
]
