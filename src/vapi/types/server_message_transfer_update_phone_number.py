...
class ServerMessageTransferUpdatePhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessageTransferUpdatePhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageTransferUpdatePhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageTransferUpdatePhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
