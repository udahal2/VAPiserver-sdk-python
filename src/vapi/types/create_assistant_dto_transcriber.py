...
class CreateAssistantDtoTranscriber_Deepgram(UniversalBaseModel):
    """
...
class CreateAssistantDtoTranscriber_Gladia(UniversalBaseModel):
    """
    These are the options for the assistant's transcriber.
    """
...
class CreateAssistantDtoTranscriber_Talkscriber(UniversalBaseModel):
    """
    These are the options for the assistant's transcriber.
    """
