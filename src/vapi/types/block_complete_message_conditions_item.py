...
class BlockCompleteMessageConditionsItem_ModelBased(UniversalBaseModel):
...
class BlockCompleteMessageConditionsItem_RuleBased(UniversalBaseModel):
...
BlockCompleteMessageConditionsItem = typing.Union[
    BlockCompleteMessageConditionsItem_ModelBased, BlockCompleteMessageConditionsItem_RuleBased
]
