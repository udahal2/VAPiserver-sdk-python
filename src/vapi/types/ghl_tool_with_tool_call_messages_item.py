...
class GhlToolWithToolCallMessagesItem_RequestStart(UniversalBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestComplete(UniversalBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestFailed(UniversalBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestResponseDelayed(UniversalBaseModel):
