...
class EndCallToolMessagesItem_RequestStart(UniversalBaseModel):
...
class EndCallToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class EndCallToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class EndCallToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
...
EndCallToolMessagesItem = typing.Union[
