...
class CreateGhlToolDtoMessagesItem_RequestStart(UniversalBaseModel):
...
class CreateGhlToolDtoMessagesItem_RequestComplete(UniversalBaseModel):
...
class CreateGhlToolDtoMessagesItem_RequestFailed(UniversalBaseModel):
...
class CreateGhlToolDtoMessagesItem_RequestResponseDelayed(UniversalBaseModel):
