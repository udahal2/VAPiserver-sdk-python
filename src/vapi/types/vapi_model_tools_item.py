...
class VapiModelToolsItem_Dtmf(UniversalBaseModel):
...
class VapiModelToolsItem_EndCall(UniversalBaseModel):
...
class VapiModelToolsItem_Voicemail(UniversalBaseModel):
...
class VapiModelToolsItem_Function(UniversalBaseModel):
...
class VapiModelToolsItem_Ghl(UniversalBaseModel):
...
class VapiModelToolsItem_Make(UniversalBaseModel):
...
class VapiModelToolsItem_TransferCall(UniversalBaseModel):
