...
class GroqModelToolsItem_Dtmf(UniversalBaseModel):
...
class GroqModelToolsItem_EndCall(UniversalBaseModel):
...
class GroqModelToolsItem_Voicemail(UniversalBaseModel):
...
class GroqModelToolsItem_Function(UniversalBaseModel):
...
class GroqModelToolsItem_Ghl(UniversalBaseModel):
...
class GroqModelToolsItem_Make(UniversalBaseModel):
...
class GroqModelToolsItem_TransferCall(UniversalBaseModel):
