...
class CustomLlmModelToolsItem_Dtmf(UniversalBaseModel):
...
class CustomLlmModelToolsItem_EndCall(UniversalBaseModel):
...
class CustomLlmModelToolsItem_Voicemail(UniversalBaseModel):
...
class CustomLlmModelToolsItem_Function(UniversalBaseModel):
...
class CustomLlmModelToolsItem_Ghl(UniversalBaseModel):
...
class CustomLlmModelToolsItem_Make(UniversalBaseModel):
...
class CustomLlmModelToolsItem_TransferCall(UniversalBaseModel):
