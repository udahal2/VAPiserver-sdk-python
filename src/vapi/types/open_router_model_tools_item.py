...
class OpenRouterModelToolsItem_Dtmf(UniversalBaseModel):
...
class OpenRouterModelToolsItem_EndCall(UniversalBaseModel):
...
class OpenRouterModelToolsItem_Voicemail(UniversalBaseModel):
...
class OpenRouterModelToolsItem_Function(UniversalBaseModel):
...
class OpenRouterModelToolsItem_Ghl(UniversalBaseModel):
...
class OpenRouterModelToolsItem_Make(UniversalBaseModel):
...
class OpenRouterModelToolsItem_TransferCall(UniversalBaseModel):
