...
class ServerMessageEndOfCallReportPhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessageEndOfCallReportPhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageEndOfCallReportPhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageEndOfCallReportPhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
