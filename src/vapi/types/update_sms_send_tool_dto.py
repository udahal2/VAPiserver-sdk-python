...
import pydantic
from .update_sms_send_tool_dto_messages_item import UpdateSmsSendToolDtoMessagesItem
from .open_ai_function import OpenAiFunction
from .server import Server
from ..core.pydantic_utilities import IS_PYDANTIC_V2


class UpdateSmsSendToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateSmsSendToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
