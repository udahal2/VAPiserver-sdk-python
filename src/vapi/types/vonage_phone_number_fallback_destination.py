...
class VonagePhoneNumberFallbackDestination_Number(UniversalBaseModel):
    """
...
class VonagePhoneNumberFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
VonagePhoneNumberFallbackDestination = typing.Union[
