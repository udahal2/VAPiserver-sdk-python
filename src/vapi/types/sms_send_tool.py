...
import pydantic
from .sms_send_tool_messages_item import SmsSendToolMessagesItem
...
class SmsSendTool(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[SmsSendToolMessagesItem]] = pydantic.Field(default=None)
    """
