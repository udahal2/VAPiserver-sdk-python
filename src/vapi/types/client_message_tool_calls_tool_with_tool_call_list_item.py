...
class ClientMessageToolCallsToolWithToolCallListItem_Function(UniversalBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Ghl(UniversalBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Make(UniversalBaseModel):
