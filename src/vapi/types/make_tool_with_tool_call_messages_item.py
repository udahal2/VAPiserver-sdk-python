...
class MakeToolWithToolCallMessagesItem_RequestStart(UniversalBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestComplete(UniversalBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestFailed(UniversalBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestResponseDelayed(UniversalBaseModel):
