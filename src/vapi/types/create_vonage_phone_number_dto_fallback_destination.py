...
class CreateVonagePhoneNumberDtoFallbackDestination_Number(UniversalBaseModel):
    """
...
class CreateVonagePhoneNumberDtoFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
CreateVonagePhoneNumberDtoFallbackDestination = typing.Union[
