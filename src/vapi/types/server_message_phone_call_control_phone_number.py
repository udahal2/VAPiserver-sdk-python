...
class ServerMessagePhoneCallControlPhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessagePhoneCallControlPhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessagePhoneCallControlPhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessagePhoneCallControlPhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
