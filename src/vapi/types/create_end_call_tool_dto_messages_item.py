...
class CreateEndCallToolDtoMessagesItem_RequestStart(UniversalBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestComplete(UniversalBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestFailed(UniversalBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestResponseDelayed(UniversalBaseModel):
