...
class ServerMessageConversationUpdatePhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessageConversationUpdatePhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageConversationUpdatePhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageConversationUpdatePhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
