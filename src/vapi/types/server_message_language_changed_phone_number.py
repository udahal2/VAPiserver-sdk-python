...
class ServerMessageLanguageChangedPhoneNumber_ByoPhoneNumber(UniversalBaseModel):
    """
...
class ServerMessageLanguageChangedPhoneNumber_Twilio(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageLanguageChangedPhoneNumber_Vonage(UniversalBaseModel):
    """
    This is the phone number associated with the call.
...
class ServerMessageLanguageChangedPhoneNumber_Vapi(UniversalBaseModel):
    """
    This is the phone number associated with the call.
