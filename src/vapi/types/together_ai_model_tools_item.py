...
class TogetherAiModelToolsItem_Dtmf(UniversalBaseModel):
...
class TogetherAiModelToolsItem_EndCall(UniversalBaseModel):
...
class TogetherAiModelToolsItem_Voicemail(UniversalBaseModel):
...
class TogetherAiModelToolsItem_Function(UniversalBaseModel):
...
class TogetherAiModelToolsItem_Ghl(UniversalBaseModel):
...
class TogetherAiModelToolsItem_Make(UniversalBaseModel):
...
class TogetherAiModelToolsItem_TransferCall(UniversalBaseModel):
