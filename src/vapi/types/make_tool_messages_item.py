...
class MakeToolMessagesItem_RequestStart(UniversalBaseModel):
...
class MakeToolMessagesItem_RequestComplete(UniversalBaseModel):
...
class MakeToolMessagesItem_RequestFailed(UniversalBaseModel):
...
class MakeToolMessagesItem_RequestResponseDelayed(UniversalBaseModel):
...
MakeToolMessagesItem = typing.Union[
