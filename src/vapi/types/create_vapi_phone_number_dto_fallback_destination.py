...
class CreateVapiPhoneNumberDtoFallbackDestination_Number(UniversalBaseModel):
    """
...
class CreateVapiPhoneNumberDtoFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
CreateVapiPhoneNumberDtoFallbackDestination = typing.Union[
