...
class CallbackStepBlock_Conversation(UniversalBaseModel):
    """
...
class CallbackStepBlock_ToolCall(UniversalBaseModel):
    """
    This is the block to use. To use an existing block, use `blockId`.
    """
...
class CallbackStepBlock_Workflow(UniversalBaseModel):
    """
    This is the block to use. To use an existing block, use `blockId`.
    """
...
CallbackStepBlock = typing.Union[CallbackStepBlock_Conversation, CallbackStepBlock_ToolCall, CallbackStepBlock_Workflow]
from .create_workflow_block_dto_steps_item import CreateWorkflowBlockDtoStepsItem  # noqa: E402

update_forward_refs(CallbackStep, CallbackStepBlock_Workflow=CallbackStepBlock_Workflow)
update_forward_refs(CreateWorkflowBlockDto, CallbackStepBlock_Workflow=CallbackStepBlock_Workflow)
update_forward_refs(HandoffStep, CallbackStepBlock_Workflow=CallbackStepBlock_Workflow)
update_forward_refs(CallbackStepBlock_Workflow)
