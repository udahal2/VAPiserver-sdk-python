...
class DeepInfraModelToolsItem_Dtmf(UniversalBaseModel):
...
class DeepInfraModelToolsItem_EndCall(UniversalBaseModel):
...
class DeepInfraModelToolsItem_Voicemail(UniversalBaseModel):
...
class DeepInfraModelToolsItem_Function(UniversalBaseModel):
...
class DeepInfraModelToolsItem_Ghl(UniversalBaseModel):
...
class DeepInfraModelToolsItem_Make(UniversalBaseModel):
...
class DeepInfraModelToolsItem_TransferCall(UniversalBaseModel):
