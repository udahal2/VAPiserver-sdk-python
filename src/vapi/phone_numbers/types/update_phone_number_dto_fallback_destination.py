...
class UpdatePhoneNumberDtoFallbackDestination_Number(UniversalBaseModel):
    """
...
class UpdatePhoneNumberDtoFallbackDestination_Sip(UniversalBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
...
UpdatePhoneNumberDtoFallbackDestination = typing.Union[
    UpdatePhoneNumberDtoFallbackDestination_Number, UpdatePhoneNumberDtoFallbackDestination_Sip
]
