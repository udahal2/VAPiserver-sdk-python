...
class PhoneNumbersGetResponse_ByoPhoneNumber(UniversalBaseModel):
...
class PhoneNumbersGetResponse_Twilio(UniversalBaseModel):
...
class PhoneNumbersGetResponse_Vonage(UniversalBaseModel):
...
class PhoneNumbersGetResponse_Vapi(UniversalBaseModel):
