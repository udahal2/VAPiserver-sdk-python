...
class PhoneNumbersDeleteResponse_ByoPhoneNumber(UniversalBaseModel):
...
class PhoneNumbersDeleteResponse_Twilio(UniversalBaseModel):
...
class PhoneNumbersDeleteResponse_Vonage(UniversalBaseModel):
...
class PhoneNumbersDeleteResponse_Vapi(UniversalBaseModel):
