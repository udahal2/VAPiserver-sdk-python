...
class BlocksListResponseItem_Conversation(UniversalBaseModel):
...
class BlocksListResponseItem_ToolCall(UniversalBaseModel):
...
class BlocksListResponseItem_Workflow(UniversalBaseModel):
...
BlocksListResponseItem = typing.Union[
    BlocksListResponseItem_Conversation, BlocksListResponseItem_ToolCall, BlocksListResponseItem_Workflow
]
update_forward_refs(CallbackStep, BlocksListResponseItem_Workflow=BlocksListResponseItem_Workflow)
