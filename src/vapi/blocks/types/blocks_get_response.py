...
class BlocksGetResponse_Conversation(UniversalBaseModel):
...
class BlocksGetResponse_ToolCall(UniversalBaseModel):
...
class BlocksGetResponse_Workflow(UniversalBaseModel):
...
BlocksGetResponse = typing.Union[BlocksGetResponse_Conversation, BlocksGetResponse_ToolCall, BlocksGetResponse_Workflow]
update_forward_refs(CallbackStep, BlocksGetResponse_Workflow=BlocksGetResponse_Workflow)
update_forward_refs(CreateWorkflowBlockDto, BlocksGetResponse_Workflow=BlocksGetResponse_Workflow)
update_forward_refs(HandoffStep, BlocksGetResponse_Workflow=BlocksGetResponse_Workflow)
