...
class BlocksUpdateResponse_Conversation(UniversalBaseModel):
...
class BlocksUpdateResponse_ToolCall(UniversalBaseModel):
...
class BlocksUpdateResponse_Workflow(UniversalBaseModel):
...
BlocksUpdateResponse = typing.Union[
    BlocksUpdateResponse_Conversation, BlocksUpdateResponse_ToolCall, BlocksUpdateResponse_Workflow
]
update_forward_refs(CallbackStep, BlocksUpdateResponse_Workflow=BlocksUpdateResponse_Workflow)
update_forward_refs(CreateWorkflowBlockDto, BlocksUpdateResponse_Workflow=BlocksUpdateResponse_Workflow)
update_forward_refs(HandoffStep, BlocksUpdateResponse_Workflow=BlocksUpdateResponse_Workflow)
