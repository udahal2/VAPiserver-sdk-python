...
class BlocksDeleteResponse_Conversation(UniversalBaseModel):
...
class BlocksDeleteResponse_ToolCall(UniversalBaseModel):
...
class BlocksDeleteResponse_Workflow(UniversalBaseModel):
...
BlocksDeleteResponse = typing.Union[
    BlocksDeleteResponse_Conversation, BlocksDeleteResponse_ToolCall, BlocksDeleteResponse_Workflow
]
update_forward_refs(CallbackStep, BlocksDeleteResponse_Workflow=BlocksDeleteResponse_Workflow)
update_forward_refs(CreateWorkflowBlockDto, BlocksDeleteResponse_Workflow=BlocksDeleteResponse_Workflow)
update_forward_refs(HandoffStep, BlocksDeleteResponse_Workflow=BlocksDeleteResponse_Workflow)
